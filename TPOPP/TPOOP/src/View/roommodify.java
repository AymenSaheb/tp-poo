...
public class roommodify extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==jButton1 || e.getSource()==jButton2)
        {
            ...
            try {
                ...
                inter.administrateur.Modifier_Chambre(Integer.parseInt(jTextField5.getText()), jCheckBox1.isSelected());
                System.out.println(inter.hotel.chambres.get(Integer.parseInt(jTextField5.getText()) - 1).vip);
